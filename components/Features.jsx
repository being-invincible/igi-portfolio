...
function Features() {
  ...
  <div class="rounded-lg mx-auto max-w-7xl p-8 lg:px-20 bg-oxford-blue">
    <div class="sm:text-center">
      ...
      <p class="mx-auto mt-4 max-w-2xl text-justify text-md font-normal leading-8 text-platinum">
    ...
    <div class=" text-center py-4 lg:px-4">
      <div class="p-2 bg-rhythm items-center text-indigo-100 leading-none rounded-xl lg:rounded-full flex lg:inline-flex" role="alert">
